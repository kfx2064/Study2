...
import kr.co.wikibook.gallery.common.utril.HttpUtils;
import kr.co.wikibook.gallery.common.utril.TokenUtils;
...
public class AccountController {
    ...
    public ResponseEntity<?> regenerate(HttpServletRequest req) {
        ...
        // 리프레시 토큰이 유효하다면
        if (StringUtils.hasLength(refreshToken) && TokenUtils.isValid(refreshToken)
            ...
            // 액세스 토큰 발급
            accessToken = TokenUtils.generate(AccountConstants.ACCESS_TOKEN_NAME, AccountConstants.MEMBER_ID_NAME,
